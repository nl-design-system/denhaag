  ...
  <Story name="With link">
    {() => (
      <table class="denhaag-table">
        ...
        <tbody class="denhaag-table__body">
          <tr class="denhaag-table__row">
            <th class="denhaag-table__heading denhaag-table__heading--link" scope="row">
              <a href="#example">Role</a>
            </th>
            <td class="denhaag-table__cell denhaag-table__cell--link">
              <a href="#example">Hero</a>
            </td>
            <td class="denhaag-table__cell denhaag-table__cell--link">
              <a href="#example">Villain</a>
            </td>
          </tr>
          <tr class="denhaag-table__row">
            <th class="denhaag-table__heading denhaag-table__heading--link" scope="row">
              <a href="#example">Weapon</a>
            </th>
            <td class="denhaag-table__cell denhaag-table__cell--link">
              <a href="#example">Power Sword</a>
            </td>
            <td class="denhaag-table__cell denhaag-table__cell--link">
              <a href="#example">Havoc Staff</a>
            </td>
          </tr>
          <tr class="denhaag-table__row">
            <th class="denhaag-table__heading denhaag-table__heading--link" scope="row">
              <a href="#example">Dark secret</a>
            </th>
            <td class="denhaag-table__cell denhaag-table__cell--link">
              <a href="#example">Expert florist</a>
            </td>
            <td class="denhaag-table__cell denhaag-table__cell--link">
              <a href="#example">Cries at romcoms</a>
            </td>
          </tr>
        </tbody>
      </table>
