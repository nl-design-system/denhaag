    ...
    {() => (
      <section class="denhaag-dynamic-content denhaag-dynamic-content--grid denhaag-dynamic-content--has-pagination">
        ...
        <nav class="denhaag-dynamic-content__pagination denhaag-pagination denhaag-pagination--center">
          ...
          <span class="denhaag-pagination__list" role="group">
            <button class="denhaag-pagination__button" aria-label="Page: 1" data-page="1">
              1
            </button>
            <button
            ...
            <button class="denhaag-pagination__button" data-page="3" aria-label="Page: 3" rel="next">
              3
            </button>
            <button class="denhaag-pagination__button" data-page="4" aria-label="Page: 4">
              4
            </button>
            <button class="denhaag-pagination__button" data-page="5" aria-label="Page: 5">
              5
            </button>
          </span>
          <button
