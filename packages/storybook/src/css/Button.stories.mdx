    ...
    {() => (
      <>
        ...
        <div class="denhaag-button-group">
          <button
            disabled
            class="denhaag-button denhaag-button--large denhaag-button--start-icon denhaag-button--disabled"
          >
            <span class="denhaag-button__icon">
              <svg
                width="1em"
        ...
        <div class="denhaag-button-group">
          <button
            disabled
            class="denhaag-button denhaag-button--large denhaag-button--end-icon denhaag-button--disabled"
          >
            <span class="denhaag-button__label">Button</span>
            <span class="denhaag-button__icon">
              <svg
