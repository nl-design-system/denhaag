...
type BasisTokens = Tokens['basis']['text']['letter-spacing'];

const basisTokens: BasisTokens = tokens['basis']['text']['letter-spacing'];

const meta: Meta = {
  title: 'Common Tokens/Letter Spacing',
  tags: ['autodocs', '!dev'],
  component: Paragraph,
  args: {
    children:
...
export const XS: Story = {
  ...
  args: {
    style: { letterSpacing: basisTokens.xs.value },
  },
};
...
export const SM: Story = {
  ...
  args: {
    style: { letterSpacing: basisTokens.sm.value },
  },
};
...
export const MD: Story = {
  ...
  args: {
    style: { letterSpacing: basisTokens.md.value },
  },
};
...
export const LG: Story = {
  ...
  args: {
    style: { letterSpacing: basisTokens.lg.value },
  },
};
...
export const XL: Story = {
  ...
  args: {
    style: { letterSpacing: basisTokens.xl.value },
  },
};
...
export const Text2XL: Story = {
  ...
  args: {
    style: { letterSpacing: basisTokens['2xl'].value },
  },
};
