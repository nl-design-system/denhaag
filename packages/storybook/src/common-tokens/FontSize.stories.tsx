...
type CommonTokens = Tokens['common']['text']['font-size'];
type BasisTokens = Tokens['basis']['text']['font-size'];
type FormControlTokens = Tokens['basis']['form-control']['font-size'];

const commonTokens: CommonTokens = tokens['common']['text']['font-size'];
const basisTokens: BasisTokens = tokens['basis']['text']['font-size'];
const formControlTokens: FormControlTokens = tokens['basis']['form-control']['font-size'];

const meta: Meta = {
  title: 'Common Tokens/Font Size',
  tags: ['autodocs', '!dev'],
  component: Paragraph,
  args: {
    children:
...
export const XS: Story = {
  ...
  args: {
    style: { fontSize: commonTokens.xs.value },
  },
};
...
export const SM: Story = {
  ...
  args: {
    style: { fontSize: basisTokens.sm.value },
  },
};
...
export const MD: Story = {
  ...
  args: {
    style: { fontSize: basisTokens.md.value },
  },
};
...
export const LG: Story = {
  ...
  args: {
    style: { fontSize: basisTokens.lg.value },
  },
};
...
export const XL: Story = {
  ...
  args: {
    style: { fontSize: basisTokens.xl.value },
  },
};
...
export const Text2XL: Story = {
  ...
  args: {
    style: { fontSize: basisTokens['2xl'].value },
  },
};
...
export const Text3XL: Story = {
  ...
  args: {
    style: { fontSize: basisTokens['3xl'].value },
  },
};
...
export const Text4XL: Story = {
  ...
  args: {
    style: { fontSize: basisTokens['4xl'].value },
  },
};
...
export const FormControl: Story = {
  ...
  args: {
    style: { fontSize: formControlTokens.value },
  },
};
