...
import FormControlLabel, { FormControlLabelProps } from '../../components/forms/FormControlLabel/FormControlLabel'
import pkg from '../../components/forms/FormControlLabel/package.json'
