...
<div class="denhaag-alert" variant="success">
  <div class="denhaag-alert__main-content">
    ...
    <div class="denhaag-alert__content">
      ...
      <button class="MuiButtonBase-root MuiButton-root denhaag-button MuiButton-contained denhaag-button--primary-action denhaag-button--medium" tabindex="0" type="button">
