...
export const Datepicker: React.FC<DatepickerProps> = forwardRef(
  (
    ...
    const outsideClickListener = (e: Event) => {
      if (!containerRef?.current?.contains(e.target as Node) && state.opened) {
        setState({
          ...state,
          opened: false,
        });
    ...
    return (
      <div className={rootStyles} ref={containerRef} data-placeholder={placeholder}>
        <button
          type="button"
