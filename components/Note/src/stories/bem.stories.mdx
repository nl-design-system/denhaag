    ...
    <div class="denhaag-note" role="note">
      ...
      >
        <path
          ...
          stroke="#4B4B4B"
        />
        <path class="denhaag-note__icon-color" d="M12 16.5V12.5" />
        <path class="denhaag-note__icon-color" d="M12 8.5H12.01" />
      </svg>
      Note
    </div>
  </Story>
  ...
  <Story name="Warning">
    <div class="denhaag-note denhaag-note--warning" role="note">
      ...
      >
        ...
        />
        <path class="denhaag-note__icon-color" d="M12 17.5H12.01" />
        <path class="denhaag-note__icon-color" d="M12 9.5V13.5" />
      </svg>
      Note warning
    </div>
  </Story>
...
<Canvas>
  ...
  <Story name="Long">
    <div class="denhaag-note" role="note">
      ...
      Etiam sed lectus ultricies tellus iaculis blandit ac eget lacus. Cras et aliquet ipsum, ac dignissim justo. Curabitur
      sodales metus non efficitur interdum. Morbi condimentum placerat fermentum. Vivamus eget risus in nisl scelerisque
      lacinia.
    </div>
  </Story>
  {/* eslint-enable react/no-unknown-property */}
