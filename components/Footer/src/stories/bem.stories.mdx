  ...
  <Story name="Default">
    <footer class="denhaag-footer">
          ...
          <div class="denhaag-footer-group">
            <div class="denhaag-link-group denhaag-link-group--dark">
              ...
              <div class="denhaag-button-group">
                <a href="#example-link" class="denhaag-button denhaag-button--primary-action">
            ...
            <div class="denhaag-link-group denhaag-link-group--dark">
              ...
              <ul class="utrecht-list-social">
                <li class="utrecht-list-social__item">
                  <a href="https://www.facebook.com/gemeenteDH/" class="utrecht-link-social" title="Facebook">
                    <svg
                ...
                <li class="utrecht-list-social__item">
                  <a href="https://twitter.com/gemeentedenhaag" class="utrecht-link-social" title="Twitter">
                    <svg
                      class="denhaag-footer__follow-us-icon"
                      width="20"
                      height="17"
                ...
                <li class="utrecht-list-social__item">
                  <a href="https://www.instagram.com/gemeentedenhaag/" class="utrecht-link-social" title="Instagram">
                    <svg
                      class="denhaag-footer__follow-us-icon"
                      width="20"
                      height="21"
      ...
      <section class="denhaag-footer__legal">
        <div class="denhaag-responsive-content">
          <div class="denhaag-footer-legal__container">
