...
<Meta title="CSS/Page Elements/Footer" />
...
<Canvas>
  ...
  <Story name="Default">
    <footer class="denhaag-footer">
      <section class="denhaag-footer__mega">
        <div class="denhaag-responsive-content denhaag-footer-contact__container">
          <div class="denhaag-footer-group">
            <div class="denhaag-link-group denhaag-link-group--dark">
              ...
              <ul class="utrecht-link-list utrecht-link-list--html-ul denhaag-link-group__list">
                <li class="denhaag-link-group__list-item">
                  <a href="#example-link" class="denhaag-link denhaag-link--with-icon denhaag-link--with-icon-start">
      ...
      <section class="denhaag-footer__contact">
        <div class="denhaag-responsive-content denhaag-footer-contact__container">
          <div class="denhaag-footer-group">
            <div class="denhaag-link-group denhaag-link-group--dark">
              <h4 class="utrecht-heading-4 denhaag-link-group__caption">Meld u aan voor de nieuwsbrief</h4>
              ...
              <div class="denhaag-button-group">
                <button class="denhaag-button">Aanmelden nieuwsbrief</button>
              </div>
              <div class="denhaag-link-group denhaag-link-group--dark">
                <h4 class="utrecht-heading-4 denhaag-link-group__caption">Volg ons op social media</h4>
                <ul id="footer-navigation-follow-us" class="denhaag-footer__follow-us-list">
                  <li class="denhaag-footer__follow-us-list-item">
                    <a
                      href="https://www.facebook.com/gemeenteDH/"
                      class="denhaag-footer__follow-us-link"
                      aria-label="facebook (Externe link)"
                    >
                      <svg
                        class="denhaag-footer__follow-us-icon"
                        width="10"
                        height="20"
                        viewBox="0 0 10 20"
                        fill="none"
                  ...
                  <li class="denhaag-footer__follow-us-list-item">
                    <a
                      ...
                      class="denhaag-footer__follow-us-link"
                      aria-label="twitter (Externe link)"
                    >
                      <svg
                        class="denhaag-footer__follow-us-icon"
                        width="20"
                  ...
                  <li class="denhaag-footer__follow-us-list-item">
                    <a
                      ...
                      class="denhaag-footer__follow-us-link"
                      aria-label="linkedin (Externe link)"
                    >
                      <svg
                        class="denhaag-footer__follow-us-icon"
                        width="20"
                      ...
                      >
                        ...
                        <path
                          ...
                          fill="currentColor"
                        />
                        <path d="M0.327239 20H4.4777V6.64256H0.327239V20Z" fill="currentColor" />
                      </svg>
                    </a>
                  </li>
                  <li class="denhaag-footer__follow-us-list-item">
                    <a
                      ...
                      class="denhaag-footer__follow-us-link"
                      aria-label="instagram (Externe link)"
                    >
                      <svg
                        class="denhaag-footer__follow-us-icon"
                        width="20"
                  ...
                  <li class="denhaag-footer__follow-us-list-item">
                    <a
                      ...
                      class="denhaag-footer__follow-us-link"
                      aria-label="youtube (Externe link)"
                    >
                      <svg
                        class="denhaag-footer__follow-us-icon"
                        width="20"
              ...
              <div class="denhaag-link-group denhaag-link-group--dark">
                <h4 class="utrecht-heading-4 denhaag-link-group__caption">Contact</h4>
                <ul class="utrecht-link-list utrecht-link-list--html-ul denhaag-link-group__list">
                  <li class="denhaag-link-group__list-item">
                    <a href="#example-link" class="denhaag-link denhaag-link--with-icon denhaag-link--with-icon-start">
                      <span class="denhaag-link__icon">
                      ...
                      <span class="denhaag-link__label">Bel ons op 14070</span>
                    </a>
                  </li>
                  <li class="denhaag-link-group__list-item">
                    <a href="#example-link" class="denhaag-link denhaag-link--with-icon denhaag-link--with-icon-start">
                      ...
                      <span class="denhaag-link__label">Contactformulier</span>
                    </a>
                  </li>
                </ul>
              </div>
      ...
      <section class="denhaag-footer__legal">
        <div class="denhaag-responsive-content denhaag-footer-legal__container">
          <div class="denhaag-footer__legal-links">
            <ul class="denhaag-list denhaag-list--vertical">
              <li class="denhaag-list__item">
                <a href="#example-link" class="denhaag-link">
                  <span class="denhaag-link__label">Sitemap</span>
                </a>
              </li>
              <li class="denhaag-list__item">
                <a href="#example-link" class="denhaag-link">
                  <span class="denhaag-link__label">Toegankelijkheid</span>
                </a>
              </li>
              <li class="denhaag-list__item">
                <a href="#example-link" class="denhaag-link">
                  <span class="denhaag-link__label">Privacy</span>
                </a>
              </li>
              <li class="denhaag-list__item">
                <a href="#example-link" class="denhaag-link">
                  <span class="denhaag-link__label">Proclaimer</span>
                </a>
              </li>
              <li class="denhaag-list__item">
                <a href="#example-link" class="denhaag-link">
                  <span class="denhaag-link__label">Disclaimer</span>
                </a>
              </li>
              <li class="denhaag-list__item">
                <a href="#example-link" class="denhaag-link">
                  <span class="denhaag-link__label">Voorwaarden</span>
                </a>
              </li>
            </ul>
          </div>
          <div class="denhaag-footer__legal-copyright">
            <p class="utrecht-paragraph">© 2021 Gemeente Den Haag</p>
          </div>
        </div>
      </section>
    </footer>
