...
<Meta
  title="CSS Components/Data Display/EventDate"
  parameters={{
...
<DesignTokenDocBlock categoryName="EventDate" viewType="table" />
...
<Canvas>
  ...
  <Story name="Default">
    <p class="denhaag-event-date">
      <svg
        class="denhaag-event-date__icon"
        width="16"
        height="17"
        viewBox="0 0 16 17"
        fill="none"
      ...
      <span class="denhaag-posttype-label denhaag-event-date__text">vrijdag 14 oktober</span>
    </p>
  </Story>
