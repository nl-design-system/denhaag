    ...
    <nav class="denhaag-breadcrumb" aria-label="Breadcrumb">
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          ...
          >
            <a class="denhaag-breadcrumb__link" href="https://example.com/" itemprop="item">
    ...
    <nav class="denhaag-breadcrumb" aria-label="Breadcrumb">
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          ...
          >
            <a
              class="denhaag-breadcrumb__link denhaag-breadcrumb__link--hover"
    ...
    <nav class="denhaag-breadcrumb" aria-label="Breadcrumb">
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          ...
          >
            <a
              class="denhaag-breadcrumb__link denhaag-breadcrumb__link--focus"
              href="https://example.com/"
              itemprop="item"
            >
              <span class="denhaag-breadcrumb__text" itemprop="name">
...
<Canvas>
  {/* eslint-disable react/no-unknown-property */}
  <Story name="RTL">
    <nav class="denhaag-breadcrumb" aria-label="Breadcrumb" dir="rtl">
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          <li
            class="denhaag-breadcrumb__item"
      ...
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          <li
            ...
            itemprop="itemListElement"
          >
            <a class="denhaag-breadcrumb__link" href="https://example.com/" itemprop="item" aria-label="Homepage">
              <svg
                width="1em"
                height="1em"
                viewBox="0 0 18 17"
...
<Canvas>
  ...
  <Story name="Without microdata">
    <nav class="denhaag-breadcrumb" aria-label="Breadcrumb">
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list">
          <li class="denhaag-breadcrumb__item">
            <a class="denhaag-breadcrumb__link" href="https://example.com/">
              <span class="denhaag-breadcrumb__text">Home</span>
              <svg
                width="1em"
                height="1em"
                viewBox="0 0 24 24"
          ...
          <li class="denhaag-breadcrumb__item">
            <a class="denhaag-breadcrumb__link" href="https://example.com/a/">
              <span class="denhaag-breadcrumb__text">Afval</span>
              <svg
                width="1em"
                height="1em"
                viewBox="0 0 24 24"
          ...
          <li class="denhaag-breadcrumb__item">
            <a
              ...
              aria-current="page"
            >
              <span class="denhaag-breadcrumb__text">Kliko&apos;s</span>
            </a>
          </li>
        </ol>
      </div>
...
<Canvas>
  ...
  <Story name="Real content situation">
    <nav id="denhaag-breadcrumb" class="denhaag-breadcrumb" aria-label="Breadcrumb">
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          <li
            class="denhaag-breadcrumb__item"
      ...
      <div class="denhaag-responsive-content">
        <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
          ...
          <li
            ...
            itemprop="itemListElement"
          >
            <a class="denhaag-breadcrumb__link" href="https://example.com/a/b/c/" itemprop="item">
              <span class="denhaag-breadcrumb__text" itemprop="name">
