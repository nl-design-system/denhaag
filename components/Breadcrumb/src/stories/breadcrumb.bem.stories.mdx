  ...
  <Story name="Default">
    <nav class="denhaag-breadcrumb">
      <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
        ...
        >
          <a class="denhaag-breadcrumb__link denhaag-link" href="https://example.com/" itemprop="item">
        ...
        >
          <a
            class="denhaag-breadcrumb__link denhaag-breadcrumb__link--current denhaag-link denhaag-link--current"
  ...
  <Story name="Hovered item">
    <nav class="denhaag-breadcrumb">
      <ol class="denhaag-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
        ...
        >
          <a
            class="denhaag-breadcrumb__link denhaag-breadcrumb__link--hover denhaag-link denhaag-link--hover"
