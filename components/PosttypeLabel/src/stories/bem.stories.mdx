...
<DesignTokenDocBlock categoryName="PosttypeLabel" viewType="table" />
...
<Canvas>
  <Story name="Default">
    <div className="denhaag-post-info">
      <p className="denhaag-post-info__label">Nieuwsbericht</p>
      <p className="denhaag-post-info__date">
        <svg
        ...
        <time className="denhaag-post-info__text" dateTime="2022-10-14">
          vrijdag 14 oktober
        </time>
      </p>
    </div>
...
<Canvas>
  <Story name="Liveblog">
    <div className="denhaag-post-info">
      <p className="denhaag-post-info__label">
        <span className="denhaag-dot--large"></span>
        Live
      </p>
      <p className="denhaag-post-info__date">
        <svg
        ...
        <time className="denhaag-post-info__text" dateTime="2024-01-29T23:12">
          Laatste update: 23:12
        </time>
      </p>
    </div>
  </Story>
