...
<Meta
  title="CSS/Actions/CTA Authentication"
  parameters={{
...
<DesignTokenDocBlock categoryName="Authentication" viewType="table" />
...
<Canvas>
  ...
  <Story name="Default">
    <div class="denhaag-cta-authentication denhaag-cta-authentication--landscape">
      <div class="denhaag-cta-authentication__card">
        <header class="denhaag-cta-authentication__header">
          <h3 class="utrecht-heading-3">Title</h3>
          <div class="utrecht-paragraph">
            <p>Subtitle</p>
          </div>
        </header>
        <div class="denhaag-cta-authentication__content">
  ...
  <Story name="Extra link">
    <div class="denhaag-cta-authentication denhaag-cta-authentication--landscape">
      <div class="denhaag-cta-authentication__card">
        ...
        <footer class="denhaag-cta-authentication__footer">
          <div class="denhaag-cta-authentication__footer-divider">
            <hr class="denhaag-divider" role="presentation" />
            <div class="denhaag-cta-authentication__footer-label">or</div>
          </div>
          <a
            class="denhaag-cta-authentication-item"
            href="#example-link"
            target="_blank"
          ...
          >
            <img
              ...
              class="denhaag-cta-authentication-item__image"
              alt=""
              loading="lazy"
            />
...
<Canvas>
  {/* eslint-disable react/no-unknown-property */}
  <Story name="Portrait">
    <div class="denhaag-cta-authentication denhaag-cta-authentication--portrait">
      <div class="denhaag-cta-authentication__card">
        <header class="denhaag-cta-authentication__header">
          <figure class="denhaag-image">
            <img
