...
<Canvas>
  <Story name="Default">
    <div className="denhaag-page-buttons">
      <button
        className="denhaag-button denhaag-button--start-icon denhaag-button--tertiary-action"
        aria-expanded="false"
        aria-controls="share-options"
      >
        <div id="share-options" className="denhaag-button__icon">
          <svg
      ...
      <div className="denhaag-share-button__options">
        <a
          ...
          className="denhaag-button denhaag-button--icon-only"
        >
          <div className="denhaag-button__icon">
            <svg
              className="denhaag-icon"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
