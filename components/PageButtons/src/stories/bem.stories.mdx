...
<Meta
  title="CSS Components/Input/PageButtons"
  parameters={{
...
<Canvas>
  ...
  <Story name="Default">
    <div class="denhaag-page-buttons">
      <div>
        <button class="denhaag-button denhaag-share-button denhaag-page-buttons__outline-dark-action">
          <svg
            class="denhaag-page-buttons__outline-dark-action__icon"
      ...
      <div class="denhaag-share-button__options">
        <a
          href="https://twitter.com/messages/compose?recipient_id=XXXX"
          aria-label="Share this page on Twitter"
          class="denhaag-button denhaag-share-button__option"
        >
          <svg
            class="denhaag-share-button__option__icon"
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
            viewBox="0 0 20 20"
