...
<Canvas>
  <Story name="Single - with date - relative">
    {() => (
      <Action link="#example" dateTime={"2023-10-02T19:47:36.593Z"} relativeDate>
        Taak
      </Action>
    )}
  </Story>
...
<Canvas>
  <Story name="Single - with warning date - relative">
    {() => (
      <Action link="#example" dateTime={"2023-09-30T19:47:36.593Z"} relativeDate>
        Taak
      </Action>
    )}
  </Story>
...
<Canvas>
  <Story name="Multiple - with date">
    {() => (
      <Action dateTime={"2023-09-28T19:47:36.593Z"} actions={<ButtonLink href="#example">Actie</ButtonLink>}>
        Taak
      </Action>
    )}
  </Story>
