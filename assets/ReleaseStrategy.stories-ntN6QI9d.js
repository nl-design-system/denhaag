import{j as e}from"./iframe-BwOYCAgr.js";import{useMDXComponents as t}from"./index-BuYfZlkK.js";import"./preload-helper-PPVm8Dsz.js";function o(r){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"release-strategy",children:"Release strategy"}),`
...
`,e.jsx(n.p,{children:"Don't use in production. Breaking changes occur frequently. The component cannot be used as CSS only component. Design tokens not implemented or experimental."})]})}function a(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}const l={title:"Den Haag/Release strategy",tags:["autodocs","!dev"],parameters:{chromatic:{disableSnapshot:!0},docs:{page:a}}},s={};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"{}",...s.parameters?.docs?.source}}};const h=["Default"];export{s as Default,h as __namedExportsOrder,l as default};
