...
`,y={overlap:"rectangle"},x={id:"react-data-display-dot-indicator",title:"React/Data Display/Dot indicator",component:i,args:y,tags:["autodocs"],parameters:{docs:{description:{component:f}}}},a={render:t=>s.jsx(i,{...t,children:s.jsx(m,{children:"Read messages"})})};var l,h,u;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: args => <DotIndicator {...args}>
      <Button>Read messages</Button>
    </DotIndicator>
}`,...(u=(h=a.parameters)==null?void 0:h.docs)==null?void 0:u.source}}};const _=["Default"];export{a as Default,_ as __namedExportsOrder,x as default};
