import{j as e}from"./iframe-hBvvBgCZ.js";import"./index-CeetSsp-.js";import"./preload-helper-PPVm8Dsz.js";var s=`.denhaag-cta-download{--denhaag-cta-download-icon-width-fallback:calc(var(--denhaag-cta-download-gap)*4);align-items:center;border-left:1px solid var(--denhaag-cta-download-border-color,currentColor);border-right:1px solid var(--denhaag-cta-download-border-color,currentColor);box-shadow:0 1px 0 var(--denhaag-cta-download-border-color,currentColor),inset 0 1px 0 var(--denhaag-cta-download-border-color,currentColor);color:var(--denhaag-cta-download-color);display:flex;flex-direction:row;font-family:var(--denhaag-cta-download-font-family,inherit);font-size:var(--denhaag-cta-download-font-size,1rem);font-weight:var(--denhaag-cta-download-font-weight,inherit);gap:var(--denhaag-cta-download-gap);line-height:var(--denhaag-cta-download-line-height,inherit);overflow-wrap:break-word;padding-block-end:var(--denhaag-cta-download-padding-block,var(--denhaag-cta-download-gap));padding-block-start:var(--denhaag-cta-download-padding-block,var(--denhaag-cta-download-gap));padding-inline-end:var(--denhaag-cta-download-padding-inline,calc(var(--denhaag-cta-download-gap)/1.5));padding-inline-start:var(--denhaag-cta-download-padding-inline,calc(var(--denhaag-cta-download-gap)/1.5));text-decoration:none}.denhaag-cta-download--hover,.denhaag-cta-download:hover{--denhaag-cta-download-dot-background-color:var(
...
}`,...i.parameters?.docs?.source}}};const p=["Default","Hovered","Focused","Grouped"];export{o as Default,d as Focused,i as Grouped,t as Hovered,p as __namedExportsOrder,g as default};
