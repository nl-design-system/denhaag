import{r as d,j as o}from"./iframe-D_4PSq6r.js";function a(n){"@babel/helpers - typeof";return a=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},a(n)}function k(n,e){if(a(n)!="object"||!n)return n;var i=n[Symbol.toPrimitive];if(i!==void 0){var t=i.call(n,e);if(a(t)!="object")return t;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}function b(n){var e=k(n,"string");return a(e)=="symbol"?e:e+""}function y(n,e,i){return(e=b(e))in n?Object.defineProperty(n,e,{value:i,enumerable:!0,configurable:!0,writable:!0}):n[e]=i,n}function v(n,e){if(n==null)return{};var i={};for(var t in n)if({}.hasOwnProperty.call(n,t)){if(e.indexOf(t)!==-1)continue;i[t]=n[t]}return i}function g(n,e){if(n==null)return{};var i,t,r=v(n,e);if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(n);for(t=0;t<s.length;t++)i=s[t],e.indexOf(i)===-1&&{}.propertyIsEnumerable.call(n,i)&&(r[i]=n[i])}return r}function f(n){var e,i,t="";if(typeof n=="string"||typeof n=="number")t+=n;else if(typeof n=="object")if(Array.isArray(n)){var r=n.length;for(e=0;e<r;e++)n[e]&&(i=f(n[e]))&&(t&&(t+=" "),t+=i)}else for(i in n)n[i]&&(t&&(t+=" "),t+=i);return t}function w(){for(var n,e,i=0,t="",r=arguments.length;i<r;i++)(n=arguments[i])&&(e=f(n))&&(t&&(t+=" "),t+=e);return t}var x=["children","className"];function u(n,e){var i=Object.keys(n);if(Object.getOwnPropertySymbols){var t=Object.getOwnPropertySymbols(n);e&&(t=t.filter(function(r){return Object.getOwnPropertyDescriptor(n,r).enumerable})),i.push.apply(i,t)}return i}function h(n){for(var e=1;e<arguments.length;e++){var i=arguments[e]!=null?arguments[e]:{};e%2?u(Object(i),!0).forEach(function(t){y(n,t,i[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(i)):u(Object(i)).forEach(function(t){Object.defineProperty(n,t,Object.getOwnPropertyDescriptor(i,t))})}return n}var p=d.forwardRef(function(e,i){var t=e.children,r=e.className,s=g(e,x);return o.jsx("a",h(h({},s),{},{className:w("nl-skip-link","nl-skip-link--visible-on-focus",r),ref:i,children:t}))});p.displayName="SkipLink";var m=".nl-skip-link{align-items:center;background-color:var(--nl-skip-link-background-color,CanvasText);box-sizing:border-box;color:var(--nl-skip-link-color,LinkText);display:inline-flex;font-size:var(--nl-skip-link-font-size);justify-content:center;line-height:var(--nl-skip-link-line-height);max-inline-size:calc(100% - var(--_nl-skip-link-inset, 0)*2);min-block-size:var(--nl-skip-link-min-block-size,44px);min-inline-size:var(--nl-skip-link-min-inline-size,44px);padding-block:var(--nl-skip-link-padding-block);padding-inline:var(--nl-skip-link-padding-inline);text-decoration-thickness:max(var(--nl-skip-link-text-decoration-thickness,0px),initial);text-underline-offset:var(--nl-skip-link-text-underline-offset,initial)}.nl-skip-link--visible-on-focus{inset-block-start:-200%;position:fixed}.nl-skip-link--visible,.nl-skip-link--visible-on-focus:focus{--_nl-skip-link-inset:2px;inset-block-start:var(--_nl-skip-link-inset,0);inset-inline-start:var(--_nl-skip-link-inset,0);position:fixed}";if(typeof document<"u"){const n=document.head||document.getElementsByTagName("head")[0],e=document.createElement("style");e.type="text/css",e.nonce=window.NONCE,n.appendChild(e),e.styleSheet?e.styleSheet.cssText=m:e.appendChild(document.createTextNode(m))}p.__docgenInfo={description:"",methods:[],displayName:"SkipLink"};const j=`# Skip Link
...
}`,...c.parameters?.docs?.source}}};const E=["Default","Focus"];export{l as Default,c as Focus,E as __namedExportsOrder,O as default};
