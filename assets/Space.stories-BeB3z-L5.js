...
`]}),`
`,e.jsx(t,{orientation:"block",tokens:Object.values(l.denhaag.space.block)})]})}function k(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(c,{...i})}):c(i)}const v={title:"Den Haag/Space",tags:["autodocs","!dev"],parameters:{chromatic:{disableSnapshot:!0},docs:{page:k}}},r={};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};const w=["Default"];export{r as Default,w as __namedExportsOrder,v as default};
