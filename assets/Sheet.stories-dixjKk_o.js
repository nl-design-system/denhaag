import{j as e}from"./iframe-BwOYCAgr.js";import{e as a}from"./index-DxZ78WWI.js";import{I as r}from"./index-DsqiA5C4.js";import{S as s,b as i,d as h}from"./index-CJrz2EKc.js";import{R as o}from"./index-Bp5z1wv2.js";import"./preload-helper-PPVm8Dsz.js";const c=`<!-- @license CC0-1.0 -->
...
## References
`,l={children:"Sheet"},S={component:s,args:l,tags:["autodocs"],parameters:{docs:{description:{component:c}}}},n={render:()=>e.jsx(s,{children:e.jsxs(o,{children:[e.jsx(r,{className:"denhaag-sheet__close-button",children:e.jsx(a,{})}),e.jsx(i,{children:"Content"})]})})},t={render:()=>e.jsx(h,{open:!0,children:e.jsx(o,{children:"Content"})})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => <Sheet>
      <ResponsiveContent>
...
}`,...t.parameters?.docs?.source}}};const C=["Default","MobileDialog"];export{n as Default,t as MobileDialog,C as __namedExportsOrder,S as default};
