import{j as e}from"./iframe-BXjMMOGN.js";import"./index-BkiBEr9m.js";import"./index-qyOv6NKy.js";import"./preload-helper-PPVm8Dsz.js";var l=".denhaag-note{align-items:flex-start;color:var(--denhaag-note-color);display:flex;flex-direction:row;font-family:var(--denhaag-note-font-family,inherit);font-size:var(--denhaag-note-font-size,1.125em);font-weight:var(--denhaag-note-font-weight,normal);gap:var(--denhaag-note-icon-spacing);line-height:var(--denhaag-note-line-height,1.3);padding-block-end:var(--denhaag-note-padding-block,calc(var(--denhaag-note-icon-spacing)/2));padding-block-start:var(--denhaag-note-padding-block,calc(var(--denhaag-note-icon-spacing)/2))}.denhaag-note>svg,.denhaag-note__icon{aspect-ratio:1/1;color:var(--denhaag-note-icon-color,#4b4b4b);flex:0 0 auto;height:auto;width:var(--denhaag-note-icon-size,calc(var(--denhaag-note-icon-spacing)*3))}.denhaag-note--info{--denhaag-note-icon-color:var(--denhaag-note-icon-info-color,#fff)}.denhaag-note--warning{--denhaag-note-icon-color:var(--denhaag-note-icon-warning-color,#fff)}.denhaag-note .denhaag-link--with-icon-end{margin-inline-end:var(--denhaag-note-icon-end-margin-inline-end)}";if(typeof document<"u"){const d=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css",n.nonce=window.NONCE,d.appendChild(n),n.styleSheet?n.styleSheet.cssText=l:n.appendChild(document.createTextNode(l))}const h=`<!-- @license CC0-1.0 -->

# Note

[![npm version](https://img.shields.io/npm/v/@gemeente-denhaag/note.svg)](https://www.npmjs.com/package/@gemeente-denhaag/note)
...
}`,...r.parameters?.docs?.source}}};const f=["Default","Info","Warning","AriaLive","Long","IconLink"];export{i as AriaLive,o as Default,r as IconLink,t as Info,s as Long,a as Warning,f as __namedExportsOrder,m as default};
