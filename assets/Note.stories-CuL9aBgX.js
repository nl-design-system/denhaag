import{j as e}from"./jsx-runtime-BjgbQsUx.js";import"./index-D6XTehw4.js";import"./index-BwW8CnKQ.js";import"./index-D2MAbzvX.js";import"./index-B3p8u_35.js";import"./_commonjsHelpers-BosuxZz1.js";var l=".denhaag-note{align-items:flex-start;color:var(--denhaag-note-color);display:flex;flex-direction:row;font-family:var(--denhaag-note-font-family,inherit);font-size:var(--denhaag-note-font-size,1.125em);font-weight:var(--denhaag-note-font-weight,normal);gap:var(--denhaag-note-icon-spacing);line-height:var(--denhaag-note-line-height,1.3);padding-block-end:var(--denhaag-note-padding-block,calc(var(--denhaag-note-icon-spacing)/2));padding-block-start:var(--denhaag-note-padding-block,calc(var(--denhaag-note-icon-spacing)/2))}.denhaag-note>svg,.denhaag-note__icon{aspect-ratio:1/1;color:var(--denhaag-note-icon-color,#4b4b4b);flex:0 0 auto;height:auto;width:var(--denhaag-note-icon-size,calc(var(--denhaag-note-icon-spacing)*3))}.denhaag-note--info{--denhaag-note-icon-color:var(--denhaag-note-icon-info-color,#fff)}.denhaag-note--warning{--denhaag-note-icon-color:var(--denhaag-note-icon-warning-color,#fff)}.denhaag-note .denhaag-link--with-icon-end{margin-inline-end:var(--denhaag-note-icon-end-margin-inline-end)}";if(typeof document<"u"){const M=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css",n.nonce=window.NONCE,M.appendChild(n),n.styleSheet?n.styleSheet.cssText=l:n.appendChild(document.createTextNode(l))}const _=`# Note
...
}`,...(c=(h=o.parameters)==null?void 0:h.docs)==null?void 0:c.source}}};var g,p,u;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`{
...
}`,...(u=(p=t.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};var m,f,w;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(w=(f=a.parameters)==null?void 0:f.docs)==null?void 0:w.source}}};var k,B,v;i.parameters={...i.parameters,docs:{...(k=i.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(v=(B=i.parameters)==null?void 0:B.docs)==null?void 0:v.source}}};var x,j,C;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => <div className="denhaag-note" role="note">
      <svg aria-label="Note:" role="img" className="denhaag-note__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 22.5C17.5228 22.5 22 18.0228 22 12.5C22 6.97715 17.5228 2.5 12 2.5C6.47715 2.5 2 6.97715 2 12.5C2 18.0228 6.47715 22.5 12 22.5Z" fill="#F1F1F1" stroke="#4B4B4B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path fill="#4B4B4B" stroke="#4B4B4B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M12 16.5V12.5" />
...
}`,...(C=(j=s.parameters)==null?void 0:j.docs)==null?void 0:C.source}}};var N,b,y;r.parameters={...r.parameters,docs:{...(N=r.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => <div className="denhaag-note" role="note" aria-atomic="true" aria-live="polite">
      <svg aria-label="Note:" role="img" className="denhaag-note__icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 22.5C17.5228 22.5 22 18.0228 22 12.5C22 6.97715 17.5228 2.5 12 2.5C6.47715 2.5 2 6.97715 2 12.5C2 18.0228 6.47715 22.5 12 22.5Z" fill="#F1F1F1" stroke="#4B4B4B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path fill="#4B4B4B" stroke="#4B4B4B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M12 16.5V12.5" />
...
}`,...(y=(b=r.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const T=["Default","Info","Warning","AriaLive","Long","IconLink"];export{i as AriaLive,o as Default,r as IconLink,t as Info,s as Long,a as Warning,T as __namedExportsOrder,V as default};
