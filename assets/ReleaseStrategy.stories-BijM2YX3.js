...
`,e.jsx(n.p,{children:"Don't use in production. Breaking changes occur frequently. The component cannot be used as CSS only component. Design tokens not implemented or experimental."})]})}function d(r={}){const{wrapper:n}={...c(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}const u={title:"Den Haag/Release strategy",tags:["autodocs","!dev"],parameters:{chromatic:{disableSnapshot:!0},docs:{page:d}}},s={};var t,i,a;s.parameters={...s.parameters,docs:{...(t=s.parameters)==null?void 0:t.docs,source:{originalSource:"{}",...(a=(i=s.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const g=["Default"];export{s as Default,g as __namedExportsOrder,u as default};
