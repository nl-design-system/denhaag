import{j as e}from"./iframe-BQ5wZTvG.js";import{r as i,A as c,a as d}from"./index-Dvl5YdpL.js";import{P as p}from"./index-Cksy5ng9.js";import{L as l}from"./index-CCaVZ4KV.js";const g=`# Navigation Link
...
`,b={component:l,tags:["autodocs"],argTypes:{disabled:{type:"boolean",options:[void 0,!0,!1],control:{type:"select"}},icon:{type:"string",options:[void 0,...Object.keys(i)],control:{type:"select"}},iconAlign:{type:"string",options:[void 0,"start","end"],control:{type:"select"}}},parameters:{docs:{description:{component:g}}}},n={args:{href:"#"},render:t=>{const r=i[t.icon];return t.icon=r?e.jsx(r,{}):t.icon||void 0,e.jsxs(p,{children:["It is possible to put ",e.jsx(l,{...t,children:"a link"})," in a Paragraph element."]})}},o={...n,args:{...n.args,disabled:!0}},a={...n,args:{...n.args,icon:e.jsx(c,{}),iconAlign:"start"}},s={...n,args:{...n.args,icon:e.jsx(d,{}),iconAlign:"end"}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    href: '#'
  },
  render: args => {
